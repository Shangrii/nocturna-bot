"""Discord adapter for the ``/recordatorio`` scheduler.

The deterministic schedule math and validators live in ``core.reminder_schedule`` and are
re-exported here to preserve existing cog call sites.
...
# ══ Discord layer (08-03) ═══════════════════════════════════════════════════════════
# The pure helpers imported above are shared with the FastAPI process. The remaining code is
